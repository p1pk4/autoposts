...
GENERATION_INSTRUCTIONS = "Используйте текст автора как основу и дополните его красивыми и плавными фразами, сохраняя его мысль и добавляя атмосферу. Текст должен быть связным, художественным, но при этом не повторять слова автора дословно. Используйте оригинальные идеи из подписи и органично вплетите их в более развернутое и эмоциональное описание. Используйте следующую информацию как основную тему: {input_text}."
